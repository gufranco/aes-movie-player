...
def measure(baked: Path, capture: Path, expected: int, window: int, overscan: int) -> int | None:
...
def main(argv: list[str]) -> int:
    ...
    found = measure(args.baked, args.capture, args.expected, args.window, args.overscan)
