...
[![Tests](https://img.shields.io/badge/tests-681%20passing-brightgreen?style=flat-square)](tools/tests)
...
**158 MB** cartridge · **35,274** frames · **59.2** fps · **846,784** tiles · **81%** of the C-ROM ceiling · **681** tests
